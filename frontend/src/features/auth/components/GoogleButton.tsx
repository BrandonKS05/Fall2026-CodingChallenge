...
/** A full navigation, not a fetch: the server redirects the browser to Google and back. */
  ...
  return (
    ...
    >
      <svg viewBox="0 0 24 24" aria-hidden className="size-4">
        ...
        <path
          fill="#EA4335"
          d="M12 4.7c1.8 0 3.3.6 4.6 1.8l3.4-3.4C18 1.2 15.2 0 12 0 7.3 0 3.2 2.7 1.2 6.6l4.1 3.1c.9-2.9 3.6-5 6.7-5z"
        />
      </svg>
